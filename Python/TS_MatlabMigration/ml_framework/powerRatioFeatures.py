...
import numpy as np
import pandas as pd
from scipy.integrate import trapz  # For AUC calculation
import matplotlib.pyplot as plt
import seaborn as sns
...
def plot_power_ratio_histograms(power_ratios_train):
    ...
    """
    # Extract the power ratio column names (all except 'Label')
    ratio_columns = [col for col in power_ratios_train.columns if col != "Label"]
