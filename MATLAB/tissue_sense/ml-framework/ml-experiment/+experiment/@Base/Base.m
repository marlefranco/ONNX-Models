...
%                  writetable(this, fullfile( paths.WriteDirectory, filename), "WriteRowNames", true );
        ...
        function plotmetric( obj, options )
            ...
            if ~isempty(modelmetrics)
                ...
                if contains(options.Metric, "f1")
                    metric = modelmetrics.(options.Metric).AvgScore;
                elseif contains(options.Metric, "AUC")
                    metric = modelmetrics.(options.Metric).AvgAUC;
                else
